...
namespace MJTelescoperPlan
{
    public class Function
    {
        ...
        private IModelStore<MJTelescoperPlanInputs> store;

        public async Task<MJTelescoperPlanOutputs> Handler(MJTelescoperPlanInputs args, ILambdaContext context)
        {
            ...
            if(this.store == null)
            {
                this.store = new S3ModelStore<MJTelescoperPlanInputs>(RegionEndpoint.GetBySystemName("us-west-1"));
            }

            var l = new InvocationWrapper<MJTelescoperPlanInputs,MJTelescoperPlanOutputs>(store, MJTelescoperPlan.Execute);
